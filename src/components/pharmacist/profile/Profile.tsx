    ...
    <div className="min-h-screen bg-[#F5F7FD] dark:bg-slate-950 py-0 px-0">
      ...
      <div className="max-w-2xl mx-auto mt-10 mb-8 px-2">
        <Card className="bg-white dark:bg-slate-800 rounded-lg shadow-[0_4px_12px_0_rgba(2,15,89,0.10)] border-2 border-transparent hover:border-[#8491D9]">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-[#021373] dark:text-white">Pharmacist Profile</CardTitle>
            <div className="text-sm text-[#8491D9] dark:text-[#C7D2FE]">Your pharmacy information</div>
          </CardHeader>
          <CardContent>
            {/* Profile Header */}
            ...
            <div className="mb-6">
              <div className="rounded-lg bg-[#010626] px-6 py-3 mb-2">
                <span className="text-white text-lg font-semibold">Pharmacy Details</span>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-slate-800 p-6 rounded-lg">
                <div>
                  <label className="block text-sm font-medium text-[#021373] dark:text-[#8491D9] mb-1">Pharmacy Name</label>
                  <div className="font-semibold text-[#010626] dark:text-white">{profile?.pharmacyName || 'Not set'}</div>
                </div>
                <div>
            ...
            <div className="flex justify-end pt-2">
              <Button
                ...
                onClick={() => navigate({ to: '/dashboard/pharmacist/profile/edit' })}
              >
                Edit Profile
              </Button>
            </div>
